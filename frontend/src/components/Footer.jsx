      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center flex-col md:flex-row gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="flex flex-wrap justify-center gap-6 text-sm font-medium">
              ...
              <a href="/#about-us" className="text-gray-500 hover:text-primary-600 transition-colors">About Us</a>
              <a href="/#contact" className="text-gray-500 hover:text-primary-600 transition-colors">Contact Us</a>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-xs text-center sm:text-left">
            &copy; 2026 MandiMitra. Helping farmers make smarter selling decisions.
          </p>
